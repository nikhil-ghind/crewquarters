...
if TYPE_CHECKING:
    from ..models.chat_message_out import ChatMessageOut


T = TypeVar("T", bound="ChatSessionDetailOut")


@_attrs_define
class ChatSessionDetailOut:
    """
    Attributes:
        id (UUID):
        title (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for messages_item_data in _messages:
            messages_item = ChatMessageOut.from_dict(messages_item_data)

            messages.append(messages_item)

        local = d.pop("local", UNSET)

        chat_session_detail_out = cls(
            id=id,
            title=title,
        ...
        chat_session_detail_out.additional_properties = d
        return chat_session_detail_out

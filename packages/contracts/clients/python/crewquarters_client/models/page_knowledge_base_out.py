...
T = TypeVar("T", bound="PageKnowledgeBaseOut")


@_attrs_define
class PageKnowledgeBaseOut:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = KnowledgeBaseOut.from_dict(items_item_data)
        ...
        page_knowledge_base_out = cls(
            items=items,
            next_cursor=next_cursor,
        )

        page_knowledge_base_out.additional_properties = d
        return page_knowledge_base_out

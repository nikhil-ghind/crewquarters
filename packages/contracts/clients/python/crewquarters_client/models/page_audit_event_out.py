...
T = TypeVar("T", bound="PageAuditEventOut")


@_attrs_define
class PageAuditEventOut:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = AuditEventOut.from_dict(items_item_data)
        ...
        page_audit_event_out = cls(
            items=items,
            next_cursor=next_cursor,
        )

        page_audit_event_out.additional_properties = d
        return page_audit_event_out

...
T = TypeVar("T", bound="PageScheduleOut")


@_attrs_define
class PageScheduleOut:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = ScheduleOut.from_dict(items_item_data)
        ...
        page_schedule_out = cls(
            items=items,
            next_cursor=next_cursor,
        )

        page_schedule_out.additional_properties = d
        return page_schedule_out

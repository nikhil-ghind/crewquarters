...
T = TypeVar("T", bound="PageDocumentOut")


@_attrs_define
class PageDocumentOut:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = DocumentOut.from_dict(items_item_data)
        ...
        page_document_out = cls(
            items=items,
            next_cursor=next_cursor,
        )

        page_document_out.additional_properties = d
        return page_document_out

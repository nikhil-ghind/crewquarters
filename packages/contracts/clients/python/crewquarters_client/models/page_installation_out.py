...
T = TypeVar("T", bound="PageInstallationOut")


@_attrs_define
class PageInstallationOut:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = InstallationOut.from_dict(items_item_data)
        ...
        page_installation_out = cls(
            items=items,
            next_cursor=next_cursor,
        )

        page_installation_out.additional_properties = d
        return page_installation_out

...
install -m 0644 "$ROOT_DIR/THIRD_PARTY_LICENSES.md" "$ROOT_DIR/NOTICE" "$ROOT_DIR/LICENSE" \
    "$PKG/usr/share/doc/crewquarters/"
cat > "$PKG/usr/share/doc/crewquarters/copyright" <<'COPYRIGHT'
Format: https://www.debian.org/doc/packaging-manuals/copyright-format/1.0/
Upstream-Name: crewquarters
Source: https://github.com/nikhil-ghind/crewquarters

Files: *
Copyright: 2026 the Crewquarters authors
License: Apache-2.0
 On Debian systems, the full text of the Apache License, Version 2.0 is in
 /usr/share/common-licenses/Apache-2.0 and in /usr/share/doc/crewquarters/LICENSE.
 Third-party components: /usr/share/doc/crewquarters/THIRD_PARTY_LICENSES.md and NOTICE.
COPYRIGHT
